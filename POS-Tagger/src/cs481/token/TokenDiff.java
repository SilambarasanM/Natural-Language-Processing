...
/**
 * Find the difference between 2 token files with Diff.
...
public class TokenDiff
{
   ...
   public static Object[] attributeArray(Vector v, String which_key)
   {
      Vector a = new Vector();
   ...
   public static void main(String[] argv) throws Exception
   {
      if(argv.length != 2)
      {
         ...
         System.err.println(
            "Format:  java cs481.token.TokenDiff <file 1> <file 2>");
         System.err.println(
            "Example: java cs481.token.TokenDiff correctanswers.xml youranswers.xml");
         System.exit(1);
      }
      ...
      // Takes too much memory for decent size testing files
      //Diff.printdiff(t1, t2, Diff.difflist(t1, t2)); 
   }
}

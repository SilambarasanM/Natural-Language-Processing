 ...
 * System.out.println("Diff = " + Diff.diff(o1, o2));
 * Diff.printdiff(o1, o2, Diff.difflist(o1, o2));
 * </pre>
 *
...
public class Diff
{
    ...
    * @param diff The difference between x and y as calculated by difflist
    */
   public static void printdiff(Object[] x, Object[] y, int[] diff)
   {
